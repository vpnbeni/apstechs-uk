...
const ContactMap = () => {
  ...
  return (
    <div className="w-full h-screen flex justify-center items-center ">
      {/* left side map */}
      <div className="w-1/2 h-full bg-primaryText flex justify-center items-center">
        <img
