...
const siteVisitImages = [
  ...
  "/assets/gallery/14.jpg", "/assets/gallery/15.jpg", "/assets/gallery/16.jpg", "/assets/gallery/17.jpg","/assets/gallery/18.jpg", "/assets/gallery/19.jpg", "/assets/gallery/22.jpg", "/assets/gallery/23.jpg",
  "/assets/gallery/24.jpg", "/assets/gallery/33.jpg", "/assets/gallery/34.jpg", "/assets/gallery/35.jpg",
  "/assets/gallery/36.jpg", "/assets/gallery/37.jpg", "/assets/gallery/38.jpg",
];

const officeActivitiesImages = [
   "/assets/gallery/25.jpg", "/assets/gallery/26.jpg", "/assets/gallery/27.jpg",
...
const Gallery = () => {
  ...
  const currentImages = activeTab === 'siteVisit' ? siteVisitImages : officeActivitiesImages;

  return (
    <div className="container mx-auto p-4">
      <div className="flex justify-center mb-6 border-b gap-4">
        <button
          className={`px-6 py-2 rounded-full transition-colors ${
            activeTab === 'siteVisit'
              ? "bg-blue-600 text-white"
              : "bg-white/10  hover:bg-white/20 border-blue-600 border text-blue-600"
          }`}
        ...
        <button
          className={`px-6 py-2 rounded-full transition-colors ${
            activeTab === 'officeActivities'
              ? "bg-blue-600 text-white"
              : "bg-white/10  hover:bg-white/20 border-blue-600 border text-blue-600"
          }`}
          onClick={() => setActiveTab('officeActivities')}
        >
          Office Activities
        </button>
      </div>
